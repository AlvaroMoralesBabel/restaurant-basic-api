...
public class LocalesControllerImpl implements LocalesController {
    ...
    @Override
    @GetMapping("")
    @Operation(summary = "Obtener todos los locales")
    ...
    @Override
    @GetMapping("/{cif}")
    @Operation(summary = "Obtener un local por su cif")
    ...
    @Override
    @PutMapping("/{cif}")
    @Operation(summary = "Crear o actualizar un local")
    ...
    @Operation(summary = "Obtener los platos de un local")
    ...
    @Operation(summary = "Añadir un plato a un local")
    ...
    @Operation(summary = "Eliminar un plato de un local")
